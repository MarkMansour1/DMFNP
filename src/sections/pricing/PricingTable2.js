						...
						<Table>
							<thead>
								<tr>
									<th
										scope="col"
										className="title-col sin-title-box"></th>
									<th
										scope="col"
										className="basic-col sin-title-box">
										Basic
									</th>
									<th
										scope="col"
										className="standard-col sin-title-box">
										Standard
									</th>
									<th
										scope="col"
										className="premium-col sin-title-box">
										Premium
									</th>
									<th
										scope="col"
										className="ent-col sin-title-box">
										Enterprise
									</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr className="price-block-row">
									<th
										scope="row"
										className="title-col sin-box"></th>
									<td className="basic-col sin-box">
